...
export default function Home() {
  ...
  return (
    <>
      <div className={`${!isAuthenticated ? "filter blur-[2px] opacity-80 pointer-events-none select-none" : ""}`}>
  ...
  <div className="flex justify-center mt-4">
    ...
    <Dialog open={showTitleDialog} onOpenChange={setShowTitleDialog}>
      ...
      {!isAuthenticated && <PasswordDialog onCorrectPassword={() => setIsAuthenticated(true)} />}
    </>
  );
}